...
description: Derived from BQAA observation, not authored. Observed at rank 4 of 6 in retrieval envelope okf:env-0f6c2b8a4d9e4f0a.
status: draft
tags: [bqaa-derived, observer-only, policy]
sources:
...
- context_ref `okf:env-0f6c2b8a4d9e4f0a`, rank 4 of 6, mode `current`.
- Observed type `Policy`; authored body not observed.
