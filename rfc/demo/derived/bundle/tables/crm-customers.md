...
type: BigQuery Table
title: CRM customers
description: Derived from BQAA observation, not authored. Observed at rank 6 of 6 in retrieval envelope okf:env-0f6c2b8a4d9e4f0a.
status: draft
tags: [bqaa-derived, observer-only, bigquery-table]
sources:
...
- context_ref `okf:env-0f6c2b8a4d9e4f0a`, rank 6 of 6, mode `current`.
- Observed type `BigQuery Table`; authored body not observed.
