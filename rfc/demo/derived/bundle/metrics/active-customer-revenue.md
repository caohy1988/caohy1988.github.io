...
description: Derived from BQAA observation, not authored. Observed at rank 1 of 6 in retrieval envelope okf:env-0f6c2b8a4d9e4f0a.
status: draft
...
- context_ref `okf:env-0f6c2b8a4d9e4f0a`, rank 1 of 6, mode `current`.
- Observed type `Metric`; authored body not observed.
- Edge `governed_by` → [Revenue recognition eligibility](../policies/revenue-recognition-eligibility.md) (inferred from envelope attributes).
