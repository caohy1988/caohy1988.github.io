...
- **Closed state.** 637 visible words (Chromium; identical in Firefox and WebKit) and 1,968 px tall at 1280 × 720; open state 3,697 px. Three evidence links are reachable without expanding the design: graph spike report, receipt example report and merged SDK PR 479.
