...
3. **Verifiable execution:** a declared computation needs a job, authoritative result evidence and an enforcing consumer. The merged receipt example demonstrates a narrow version of this boundary. Full-RFC/demo computation attesters remain stubs and its receipts remain UNVERIFIABLE.
