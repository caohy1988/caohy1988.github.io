...
SELECT concept_id, relation, edge_declaration, edge_at, edge_resolution, edge_inferred,
...
FROM GRAPH_TABLE(`{ds}.okf_graph`
  ...
  COLUMNS (c.node_id AS concept_id, e.relation AS relation, e.declaration AS edge_declaration, e.authored_at AS edge_at,
